    ...
    <div className="learn-shell">
      ...
      <main className="learn-content">
        ...
        <section className="learn-grid" aria-label="Guias de aprendizagem">
          <article className="learn-card"><span className="feature-icon"><PenTool size={22} /></span><span className="lesson-number">01 · Fundamentos</span><h2>Desenho vetorial preciso</h2><p>Use nós de canto ou suaves, alças Bézier e zoom para construir curvas limpas. Alinhar move âncoras e alças juntas, preservando o desenho.</p><ul><li>Comece com poucos nós.</li><li>Feche somente contornos prontos.</li><li>Use guias como referência, não como ornamento.</li></ul></article>
